...
test("(5 pts) (scenario) hash functions return different nodes", () => {
  ...
  let key1 = "8bc3d6507cf9d936284e4b2e2a534153406dd45ee786c3619af4f24eb33418f9";
  // key2 = key1 + 1
  let key2 = "8bc3d6507cf9d936284e4b2e2a534153406dd45ee786c3619af4f24eb33418fa";
  console.log(nodeIds);
  console.log(nodeIds.map((id) => parseInt(id, 16)));
  console.log(parseInt(key1, 16));
  console.log(parseInt(key2, 16));
  const kid1 = util.id.getID(key1);
  const kid2 = util.id.getID(key2);
  console.log(parseInt(kid1, 16));
  console.log(parseInt(kid2, 16));
...
test("(5 pts) (scenario) hash functions return the same node", () => {
  ...
  console.log(nodeIds.map((id) => parseInt(id, 16)));
  console.log(nodeIds);
  console.log(parseInt(kid, 16));
  console.log(kid);
  const a = util.id.naiveHash(kid, nodeIds);
  console.log(a);
  // 8bc3d6507cf9d936284e4b2e2a534153406dd45ee786c3619af4f24eb33418f9
  const b = util.id.rendezvousHash(kid, nodeIds);
  //a3f35aa89844440daad2f5e826f8c3a0c95c6ea05825da74ef5e065c1b488f60
  console.log(b);
  const c = util.id.consistentHash(kid, nodeIds);
  // e7d751b3a2f64088ecf206cc4ff647101c0c08b3f6c7e382ff1ba3a734666762
  console.log(c);
  expect(a).toBe(b);
  expect(b).toBe(c);
});
...
test("(5 pts) (scenario) use mem.reconf", (done) => {
  ...
  */
  ...
  const checkPlacement = (e, v) => {
    ...
    const remote = { node: n5, service: "mem", method: "get" };
